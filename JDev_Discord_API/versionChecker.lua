Citizen.CreateThread(function()
    updatePath = "/JulienRed/JDev_Discord_API" 
    resourceName = "JDev_Discord_API ("..GetCurrentResourceName()..")" 
   ...
   PerformHttpRequest("https://raw.githubusercontent.com/JulienRed/JDev_Discord_API/main/version.txt", checkVersion, "GET")
end)